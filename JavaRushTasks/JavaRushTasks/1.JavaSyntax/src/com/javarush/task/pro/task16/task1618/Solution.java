...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ZonedDateTime z1 = ZonedDateTime.now(fromZone).withZoneSameInstant(fromZone);
        ZonedDateTime z2 = ZonedDateTime.now(toZone).withZoneSameInstant(toZone);
        return fromDateTime.minusHours(z1.getHour() - z2.getHour());
