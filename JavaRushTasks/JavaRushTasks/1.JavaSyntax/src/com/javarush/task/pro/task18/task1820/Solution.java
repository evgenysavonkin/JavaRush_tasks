...
public class Solution {
    ...
    public static Optional<Car> getMostExpensiveCar(Stream<Car> cars) {
        Optional<Car> carOptional = cars.max((o1, o2) -> o1.getPrice() - o2.getPrice());
        return carOptional;
    }

    public static Optional<Car> getMoreExpensiveCar(Stream<Car> cars, Car mostExpensiveCar) {
        Optional<Car> mostExpensiveCarOpt = cars.filter(p1 -> mostExpensiveCar.getPrice() <p1.getPrice()).findFirst();
        return mostExpensiveCarOpt;
    }
}
